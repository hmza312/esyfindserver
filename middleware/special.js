...
exports.specialById = (req, res, next, id) => {
  Special.find({}).exec((err, business) => {
    if (err || !business) {
    ...
    if (error) {
      ...
      if (req.file == undefined) {
        ...
        try {
          ...
          let business = await Special.findByIdAndUpdate(req.params.businessId, { $set: { photo: fullPath } }, { new: true });
...
exports.remove = (req, res) => {
    ...
    Special.findOneAndDelete({ _id: req.params.businessId })
